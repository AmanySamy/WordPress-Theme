        ...
        ?>
            ...
            <div class="row author">
                ...
                <div class="col-md-10 author-info">
                    ...
                    <div class="row autor-posts-info">
                        <div class="col-md-6 author-posts-count">
                            <span> Author Posts Count :</span>
                        
                            <?php echo count_user_posts(get_the_author_meta('ID')) ?>
                            <i class="fa fa-pencil-square-o fa-fw fa-lg"></i>
                        </div>
                        <div class="col-md-6 author-posts-link text-right">
                            <span>Visit Author Profile</span> 
                            <?php the_author_posts_link(); 
                            echo '<i class="fa fa-hand-o-right fa-fw fa-lg"></i>' ?>
                        </div>
                    </div>
                </div><!--  End Author Info -->
            </div>
